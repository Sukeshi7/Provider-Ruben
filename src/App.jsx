...
import MachinesView   from "./components/MachineView";
    ...
    <div className="app">
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          <a
            href="#"
            className={page === "deploy" ? "nav-active" : ""}
            onClick={(e) => { e.preventDefault(); setPage("deploy"); }}
          >
            Dashboard
          </a>
          <a
            href="#"
            className={page === "machines" ? "nav-active" : ""}
            onClick={(e) => { e.preventDefault(); setPage("machines"); }}
          >
            Machines
          </a>
          <a href="#">Docs</a>
